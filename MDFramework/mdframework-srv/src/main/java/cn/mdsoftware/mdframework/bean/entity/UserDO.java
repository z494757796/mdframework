...
public class UserDO implements Serializable {
    ...
    private String eolinkerAcount;
    private String gitAccount;

    public String getEolinkerAcount() {
        return eolinkerAcount;
    }

    public void setEolinkerAcount(String eolinkerAcount) {
        this.eolinkerAcount = eolinkerAcount;
    }
